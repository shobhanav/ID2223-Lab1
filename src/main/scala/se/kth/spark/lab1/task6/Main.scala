...
object Main {
  def main(args: Array[String]) {
    ...
    val myLR = new MyLinearRegressionImpl().setLabelCol("yearDouble").
    ...
    val task3ModelSummary = pipelineModel.stages(lrStage).asInstanceOf[MyLinearModelImpl]
    println(s"RMSE : ${task3ModelSummary.trainingError.sum / task3ModelSummary.trainingError.size }")
